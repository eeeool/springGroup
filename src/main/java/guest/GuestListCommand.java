...
public class GuestListCommand implements CommonInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 블록페이징 처리 (시작 블록을 0으로 처리했다. 1블록의 크기는 3)
		// 1. 블록의 크기결정(3)
		int blockSize = 3;
		
		// 2. 현재 페이지가 속한 블록번호를 구한다. (예: 총 레코드수가 23개일경우, 1페이지 분량이 5개일경우, 총 페이지수는 5Page이다.)
		...
		request.setAttribute("toRecCnt", totRecCnt);
