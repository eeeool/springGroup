...
public class BoardDAO {
	...
	public List<BoardVO> getBoardList(int startIndexNo, int pageSize) {
		...
		try {
			...
			System.out.println("SQL 오류(getBoardList): " + e.getMessage());
		} finally {
			rsClose();
		}
		return vos;
	...
	public int setBoardInputOk(BoardVO vo) {
		...
		try {
			...
			System.out.println("SQL 오류(setBoardInputOk): " + e.getMessage());
		} finally {
			pstmtClose();
		}
	...
	public List<BoardVO> BoardSearchList(String search, String searchString) {
		...
		try {
			...
			System.out.println("SQL 오류(BoardSearchList): " + e.getMessage());
		} finally {
			rsClose();
		}
		return vos;
	...
	public List<BoardReplyVO> getBoardReplyList(int idx) {
		...
		try {
			...
			System.out.println("SQL 오류(getBoardReplyList): " + e.getMessage());
		} finally {
			rsClose();
		}
	...
	public int setBoardReplyInputOk(BoardReplyVO vo) {
		...
		try {
			...
			System.out.println("SQL 오류(setBoardReplyInputOk): " + e.getMessage());
		} finally {
			pstmtClose();
		}
	...
	public int setBoardReplyDelete(int idx) {
		...
		try {
			...
			System.out.println("SQL 오류(setBoardReplyDelete): " + e.getMessage());
		} finally {
			pstmtClose();
		}
	...
	public int setBoardReplyUpdateOk(int idx, String content) {
		...
		try {
			...
			System.out.println("SQL 오류(setBoardReplyUpdateOk): " + e.getMessage());
		} finally {
			pstmtClose();
		}
