...
<div class="container">
  <table class="table table-borderless m-0 p-0">
	  ...
	  <tr>
	  	<td>(<font color="blue"><b>${searchStr}</b></font>(으)로 <font color="red"><b>${searchString}</b></font>(을)를 검색한 결과 <font color="blue"><b>${fn:length(vos)}</b></font>건이 검색되었습니다.)</td>
  ...
  <table class="table table-hover text-center">
  	...
  	<c:forEach var="vo" items="${vos}" varStatus="st">
  		<tr>
  			...
  			<!-- 글 조회수 옆에 좋아요가 0이 아닐경우 좋아요 횟수를 괄호안에 적어준다. -->
  			<td>${vo.readNum}
