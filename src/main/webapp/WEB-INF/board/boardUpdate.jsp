...
<div class="container">
  ...
  <form name="myform" method="post" action="BoardUpdateOk.bo">
  	<table class="table table-bordered">
  		...
  		<tr>
  			<th>글제목</th>
  			<td><input type="text" name="title" id="title" placeholder="글 제목을 입력하세요" value="${vo.title}" autofocus required class="form-control" /></td>
  		</tr>
  		<tr>
  			<th>글내용</th>
  		...
  		<tr>
  			<td colspan="2" class="text-center">
  				...
  				<input type="button" value="돌아가기" onclick="location.href='BoardList.bo??pag=${pag}&pageSize=${pageSize}';" class="btn btn-info me-2" />
  			</td>
  		</tr>
  	</table>
  	...
  	<input type="hidden" name="hostIp" value="${pageContextPath.request.remoteAddr}" />
  </form>
</div>
<p><br/></p>
