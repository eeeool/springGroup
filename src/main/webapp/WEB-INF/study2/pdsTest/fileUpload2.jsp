...
<head>
  ...
  <script>
  	...
  	function fCheck() {
  		...
  		let fName = document.getElementById('file2').value;
  		let fName = document.getElementById('file3').value;
  		...
  		if (fileSize1 > maxSize || fileSize2 > maxSize || fileSize3 > maxSize) {
  			alert('업로드할 파일의 최대용량은 최대 용량은 10MByte 이하로 등록하세요');
  		}
...
<div class="container">
  ...
  <form name="myform" method="post" action="FileUploadOk2.st" enctype="multipart/form-data">
  	<div class="">
  		...
  		<input type="file" name="fName2" id="file2" class="form-control" />
  		<input type="file" name="fName3" id="file3" class="form-control" />
  ...
  <hr/>
  <div class="row">
  	<div class="col"><a href="FileList.st" class="btn btn-primary form-control">파일 목록보기</a></div>
