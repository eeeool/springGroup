...
<div class="container">
  ...
  <c:forEach var="file" items="${files}" varStatus="st">
	  ...
	  <div class="mb-3">
		  ...
		  <c:if test="${extName == 'doc'}">Word 문서파일</c:if>
		  <c:if test="${extName == 'ppt' || extName == 'pptx'}">파워포인트 문서파일</c:if>
		  <c:if test="${extName == 'pdf'}">PDF 문서파일</c:if>
		  <c:if test="${extName == 'txt'}">텍스트 문서파일</c:if>
