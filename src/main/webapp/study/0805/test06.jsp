...
<div class="container">
  <h2>전송방식(GET/POST)</h2>
  <p>Get방식1: <a href='/springGroup/j0805/Test6_1?flag=1' class='btn btn-success'>Test6_1 서블릿 호출</a></p>
  <p>Get방식2: <a href='<%=request.getContextPath()%>/j0805/Test6_2?flag=2' class='btn btn-success'>Test6_2 서블릿 호출</a></p>
  <hr />
  <div>
