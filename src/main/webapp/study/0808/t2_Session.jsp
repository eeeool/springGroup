...
<div class="container">
  ...
  <form name="myform" method="post" action="t2_SessionSave.jsp">
	  ...
	  <div class='row text-center'>
	  	<div class='col'><button  type="submit" class='btn btn-success'>세션 저장</button></div>
	  	<div class='col'><a href='t2_SessionCheck.jsp' class='btn btn-primary'>세션 확인</a></div>
	  	<div class='col'><a href='t2_SessionAllDelete.jsp' class='btn btn-danger'>세션 전체삭제</a></div>
