...
<div class="container">
  ...
  <pre>
  	사용법: $ {변수/값/객체/수식}
  	용도: 사용자가 '변수/값/객체/수식' 등을 서버로부터 전송받은 후 해당 자료를 '저장', '계산', '선언' 등의 처리용도로 사용
  ...
  <hr />
  	...
  	<p>폼 태그 또는 get방식을 통해서 넘어온 값에 대한 처리를 할 수 있다. (주소?변수1=값1&변수2=값2......)</p>
  	...
  	<div>
  		<form name="myform" method="post" action=${pageContext.request.contextPath}/j0807/ELtest>
  			<div>성명
  				<input type="text" name="name2" value="이기자" calss="form-control"/>
  			</div>
  			<div class='mb-3'>직업
